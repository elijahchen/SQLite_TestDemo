...
public class MainActivity extends Activity {
	...
	public void sortClicked(View view){
		Cursor query = db.query("Student", new String[]{"stud_id, stud_name"}, null, null, null, null, "stud_name ASC");

		data.clear();

		while(query.moveToNext()){
			HashMap<String, String> map = new HashMap<String, String>();
			map.put("stud_id", query.getString(0));
			map.put("stud_name", query.getString(1));
			data.add(map);
		}
		query.close();
		adapter.notifyDataSetChanged();
